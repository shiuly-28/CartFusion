...
function ShopPage() {
    ...
    py-6 px-4 text-white text-xl sm:text-3xl text-center flex flex-col items-center justify-center gap-4'>
                {!isHomePage && (
                    <button 
                        onClick={() => router.push('/')}
    ...
    via-black to-gray-900 text-white px-3 sm:px-6 py-4 sm:py-6'>
            <div className='max-w-7xl mx-auto mb-6 sm:mb-8'>
                {/* Home page na hole ebong mobile/desktop shob device-ei conditional control */}
                {!isHomePage && (
                    <button 
                        onClick={() => router.push('/')}
                ...
                <div className='text-center'>
                    <h1 className='text-xl sm:text-3xl font-bold text-white'>Explore Trusted Shop & Verified Sellers</h1>
                    <p className='text-gray-300 text-xs sm:text-sm mt-1'>Discover Verified Merchant, authentication stores & their exclusive products.</p>
                </div>
            </div>
            ...
            border border-white/10 hover:border-white/30 hover:shadow-2xl transition-all duration-300 flex flex-col justify-between'>
                  ...
                  bg-black/40 flex items-center justify-center border border-white/5'>
                                ...
                                <h2 className='font-semibold text-center text-gray-100 text-base sm:text-lg'>{v.shopName}</h2>
